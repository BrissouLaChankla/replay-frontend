  ...
  return (
    <div>
      <header className="relative min-h-72 h-[38vh]  md:h-[50vh] md:pb-12 overflow-hidden">
        {
          !!videos.length &&
          <video autoPlay loop muted className="absolute min-w-full min-h-full -z-10 md:w-full md:-top-1/2 max-w-fit " style={{ filter: "brightness(0.5)" }}>
      ...
      <div className="max-w-7xl m-auto pt-8 md:pt-16 pb-5">
